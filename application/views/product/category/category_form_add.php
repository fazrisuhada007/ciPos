            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-8 col-md-9 col-sm-12">
                        <input type="text" class="form-control m-input" name="category_name" placeholder="Enter category name" data-toggle="m-tooltip" title="Nama wajib diisi." value="<?= set_value('category_name') ?>" autocomplete="off" autofocus>
