            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-8 col-md-9 col-sm-12">
                        <input type="hidden" name="unit_id" value="<?= $row->unit_id ?>"> <input type="text" class="form-control m-input" name="unit_name" placeholder="Enter name" data-toggle="m-tooltip" title="Nama wajib diisi." value="<?= $this->input->post('unit_name') ?? $row->name ?>" autocomplete="off" onkeyup="this.value=value.replace(/[^\a-\z\A-\Z\s]*$/,'')" autofocus>
