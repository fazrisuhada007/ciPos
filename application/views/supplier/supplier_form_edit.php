            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-8 col-md-9 col-sm-12">
                        <input type="hidden" name="supplier_id" value="<?= $row->supplier_id ?>"> <input type="text" class="form-control m-input" name="supplier_name" placeholder="Enter name" data-toggle="m-tooltip" title="Nama wajib diisi." value="<?= $this->input->post('supplier_name') ?? $row->name ?>" autocomplete="off" onkeyup="this.value=value.replace(/[^\a-\z\A-\Z\s]*$/,'')" autofocus>
                ...
                <div class="form-group m-form__group row" style="margin-top: -25px;">
                    ...
                    <div class="col-lg-8 col-md-9 col-sm-12">
                        <textarea class="form-control m-input" name="description" placeholder="Enter description"><?= $this->input->post('description') ?? $row->description ?></textarea>
