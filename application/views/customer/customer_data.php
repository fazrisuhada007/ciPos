            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="<?= site_url('customer/add') ?>" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air btn-width btn-line-heigh-mobile">
                            <span>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <form action="<?= site_url('customer/del') ?>" method="post">
                                        <a href="<?= site_url('customer/edit/' . $data->customer_id) ?>" class="btn btn-info btn-sm m-btn  m-btn m-btn--icon btn-xs btn-width btn-line-heigh-mobile" style="margin-left:1px; margin-top: 3px">
                                            <span>
