            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-8 col-md-9 col-sm-12">
                        <input type="hidden" name="user_id" value="<?= $row->user_id ?>"> <input type="text" class="form-control m-input" name="fullname" placeholder="Enter name" data-toggle="m-tooltip" title="Nama wajib diisi." value="<?= $this->input->post('fullname') ?? $row->name ?>" autocomplete="off" onkeyup="this.value=value.replace(/[^\a-\z\A-\Z\s]*$/,'')" autofocus>
                ...
                <div class="form-group m-form__group row" style="margin-top: -25px;">
                    ...
                    <div class="col-lg-8 col-md-9 col-sm-12">
                        <input type="text" class="form-control m-input" name="username" placeholder="Enter username" data-toggle="m-tooltip" title="Username wajib diisi." value="<?= $this->input->post('username') ?? $row->username ?>" autocomplete="off">
                ...
                <div class="form-group m-form__group row" style="margin-top: -25px;">
                    ...
                    <div class="col-lg-8 col-md-9 col-sm-12">
                        <input type="password" class="form-control m-input" name="password" placeholder="Biarkan kosong jika tidak diganti" data-toggle="m-tooltip" title="Biarkan kosong jika tidak diganti." value="<?= $this->input->post('password') ?>">
                ...
                <div class="form-group m-form__group row" style="margin-top: -25px;">
                    ...
                    <div class="col-lg-8 col-md-9 col-sm-12">
                        <input type="password" class="form-control m-input" name="passconf" placeholder="Biarkan kosong jika tidak diganti." data-toggle="m-tooltip" title="Biarkan kosong jika tidak diganti." value="<?= $this->input->post('passconf') ?>">
                        <span class="m-form__help"><?= $this->input->post('passconf') ?></span>
                    </div>
                </div>
                <div class="form-group m-form__group row" style="margin-top: -25px;">
